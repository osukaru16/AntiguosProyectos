...
class MotorTamagochi{
	...
	public boolean estaMuerto(){
		if((hambre<0)||(hambre>Maxhambre)){return true;}
		if((sed<0)||(sed>Maxsed)){return true;}
		if((cansancio<0)||(cansancio>Maxcansancio)){return true;}
	    if((aburrimiento<0)||(aburrimiento>Maxaburrimiento)){return true;}
	    if((suciedad<0)||(suciedad>Maxsuciedad)){return true;}
		if((necesidad<0)||(necesidad>Maxnecesidad)){return true;}
